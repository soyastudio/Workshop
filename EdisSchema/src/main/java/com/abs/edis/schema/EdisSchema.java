...
public class EdisSchema {
    ...
    static {
        ...
        Class<?>[] classes = EdisSchema.class.getDeclaredClasses();
        for (Class<?> c : classes) {
    ...
    public EdisSchema(InputStream inputStream) {
    ...
    static class XPathDataTypeCommand extends AbstractCommand {
    ...
    static class XPathJsonTypeCommand extends AbstractCommand {
        ...
        private String getSimpleType(SchemaType schemaType) {
            ...
            if (base == null || XmlBeansUtils.getXMLBuildInType(base) == null) {
                ...
                String type = null;
                XmlBeansUtils.XMLBuildInType buildInType = XmlBeansUtils.getXMLBuildInType(base);
                String className = buildInType.getJavaType().getSimpleName();
                switch (className) {
                    case "boolean":
                        type = "boolean";
                        break;
    ...
    static class SampleXmlCommand extends AbstractCommand {
    ...
    static class AvroSchemaCommand extends AbstractCommand {
    ...
    static class SampleAvroCommand extends AbstractCommand {
