...
public class XPathAssignmentAnnotator extends EdisAnnotator {
    ...
    public void annotate(KnowledgeTree<SchemaTypeSystem, XsNode> knowlegeBase) throws T123W.FlowExecutionException {
        ...
        knowlegeBase.paths().forEachRemaining(e -> {
            ...
            EdisTask.Function[] funcs = EdisTask.Function.fromString(value);
            if(funcs != null && funcs.length > 0) {
                if(XsNode.XsNodeType.Folder.equals(xsNode.getNodeType())) {
                    ...
                    if(construction == null) {
                        construction = new EdisTask.Construction();
                    }
                    ...
                    EdisTask.Assignment assignment = knowlegeBase.get(e).getAnnotation(NAMESPACE_ASSIGNMENT, EdisTask.Assignment.class);
                    if(assignment == null) {
                        assignment = new EdisTask.Assignment();
                    }
