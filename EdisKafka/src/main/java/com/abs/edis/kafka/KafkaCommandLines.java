...
public class KafkaCommandLines {
    ...
    static {
        Method[] methods = KafkaCommandLines.class.getDeclaredMethods();
    ...
    public static void configure(Properties properties) {
        KafkaConnections.configure(properties);
    }
    ...
    public static CommandLine build(JsonObject jsonObject) {
        return null;
    }
    ...
    public static String execute(CommandLine cmd) throws Exception {
        ...
        Method method = KafkaCommandLines.class.getMethod(action, new Class[]{CommandLine.class});
        if (method.getAnnotation(Command.class) == null) {
    ...
    protected static KafkaConnections kafkaClientFactory(CommandLine command) {
        String env = "LOCAL";
        if (command.hasOption("e")) {
            env = command.getOptionValue("e");
        }

        return KafkaConnections.getInstance(env);
    }
