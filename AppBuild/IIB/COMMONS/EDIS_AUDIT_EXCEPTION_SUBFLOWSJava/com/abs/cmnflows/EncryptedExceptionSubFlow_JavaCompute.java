...
public class EncryptedExceptionSubFlow_JavaCompute extends com.ibm.broker.javacompute.MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			if (actualMsg != null && actualMsg.size()>0) {
				//System.out.println("********* actualMsg is not null!!!!!!!!!!");
				//System.out.println("********* actualMsg size = " + actualMsg.size());
				// MbElement element = actualMsg.get(0).getFirstChild();
				MbElement element = actualMsg.get(0).getLastChild();
				//System.out.println("*********element = " + element.getName() + ":" + element.getType()+ ":" + element.getValueAsString());
